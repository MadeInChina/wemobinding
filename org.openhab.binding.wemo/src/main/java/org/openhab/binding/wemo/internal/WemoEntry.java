...
/**
 * WemoEntry is a datastructure to represent (music) entries in the Wemo device's queue, libraries, and so forth
 * 
 * @author Karel Goderis 
 * @since 1.1.0
 * 
 */
public class WemoEntry implements Serializable {
	/**
	 * 
	 */
    ...
    public WemoEntry(String id, String title, String parentId, String album, String albumArtUri, 
